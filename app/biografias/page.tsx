        ...
        >
          <div className="flex-1">
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border border-papel-200 px-3 py-2 text-sm text-tinta-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-500 dark:border-tinta-800 dark:bg-tinta-900 dark:text-neutral-100"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 w-full rounded-md border border-papel-200 px-3 py-2 text-sm text-tinta-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-500 dark:border-tinta-800 dark:bg-tinta-900 dark:text-neutral-100 sm:w-auto"
            >
              {TIPOS.map((t) => (
